...
Mahony::Mahony()
{
    ...
    long long int timesep = 0;
}

void Mahony::update(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz, long long int timestep)
{
	float recipNorm;
...
void Mahony::updateIMU(float gx, float gy, float gz, float ax, float ay, float az, long long int timestep)
{
	float recipNorm;
