...
typedef struct {
    ts_dataxyzf32 x;
    /**< x-axis sensitivity with respect to 3-axis */
    ts_dataxyzf32 y;
    /**< y-axis sensitivity with respect to 3-axis */
...
typedef struct {
    BSX_U8 calib;
    /** enable when calib module is set */
...
typedef struct {
    ...
    BSX_U8 opMode;
    /**< bsx library operation mode of the library: bit[0] = accelerometer mode; bit[1] = magnetometer mode; bit[2] = gyroscope mode;*/
