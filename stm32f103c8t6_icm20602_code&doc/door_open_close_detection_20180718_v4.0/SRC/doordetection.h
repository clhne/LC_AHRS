...
int Door_Detection(short ax_adc, short ay_adc, short az_adc, short gx_adc, short gy_adc, short gz_adc, float *pitch, float *roll, float *cur_cor_gx, float *cor_gy, float *cor_gz, 
