...
#define OLED_CS_SET()
#else
#define OLED_CS_CLS() PAout(1)=0 // CS
#define OLED_CS_SET() PAout(1)=1
#endif

#define OLED_DC_CLS() PAout(2)=0 // DC
#define OLED_DC_SET() PAout(2)=1

#define OLED_RST_CLS() PAout(3)=0 // RES
#define OLED_RST_SET() PAout(3)=1

#define OLED_SDIN_CLS() PAout(4)=0 // DIN
#define OLED_SDIN_SET() PAout(4)=1

#define OLED_SCLK_CLS() PAout(5)=0 // CLK
#define OLED_SCLK_SET() PAout(5)=1
