...
int NDOF_DoStep(short ax_adc, short ay_adc, short az_adc, short gx_adc, short gy_adc, short gz_adc, long long ts) {
    ...
    ndof.ts = ts;
#if 0
    printf("acc_dyn:%d %d %d ref/cur x %d %d y %d %d z %d %d\n", ndof.acc_dyn_status, ndof.acc_oneG_status, ndof.acc_dyn_det_count, acc_dyn_ref_x, acc_dyn_cur_x, acc_dyn_ref_y, acc_dyn_cur_y, acc_dyn_ref_z, acc_dyn_cur_z);
    printf("gyro_dyn:%d %d %d max/min x %d %d y %d %d z %d %d\n", ndof.gyro_dyn_status, ndof.gyro_shake_status, ndof.gyro_dyn_det_count, ndof.gx_max, ndof.gx_min, ndof.gy_max, ndof.gy_min, ndof.gz_max, ndof.gz_min);
    printf("acc&gyro: %f %f %f %f %f %f bias: %f %f %f\n", ndof.cor_ax * GRAVITY * 0.001f, ndof.cor_ay * GRAVITY * 0.001f, ndof.cor_az * GRAVITY * 0.001f, ndof.cor_gx * 0.061f, ndof.cor_gy * 0.061f, ndof.cor_gz * 0.061f, ndof.gx_bias * 0.061f, ndof.gy_bias * 0.061f, ndof.gz_bias * 0.061f);
    printf("ori_quat: %f %f %f %f\n", ndof.ori_quat[0], ndof.ori_quat[1], ndof.ori_quat[2], ndof.ori_quat[3]);
#endif
