...
int  Door_Detection(short ax_adc, short ay_adc, short az_adc, short gx_adc, short gy_adc, short gz_adc, int *door_status, float *pitch, float *cur_cor_gx, long long ts);
#endif