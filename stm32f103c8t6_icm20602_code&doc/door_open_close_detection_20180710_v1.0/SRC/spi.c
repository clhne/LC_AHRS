...
void spi2_init() {
    ...
    //CS
    gpio_mode_out(GPIOB,GPIO_Pin_12);
    CS_AK = 1;
    gpio_mode_out(GPIOA,GPIO_Pin_8);
    CS_ICM = 1;
#else
    gpio_mode_af(GPIOB,GPIO_Pin_15);//MOSI
    gpio_mode_af(GPIOB,GPIO_Pin_14);//MISO
    ...
    //CS
    gpio_mode_out(GPIOB,GPIO_Pin_7);
    CS_ICM = 1;
    gpio_mode_out(GPIOB,GPIO_Pin_6);
    CS_AK = 1;

#endif
    gpio_mode_out(GPIOA,GPIO_Pin_11);
    CS_SPL = 1;
